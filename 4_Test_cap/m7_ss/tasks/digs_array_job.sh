...
#SBATCH --error=/rds/user/wd304/hpc-work/m7_ss/tasks/%A_%a.err
#SBATCH --output=/rds/user/wd304/hpc-work/m7_ss/tasks/%A_%a.out
...
task=$(sed -n "${TASK_ID}p" /rds/user/wd304/hpc-work/m7_ss/tasks/tasks.txt)
