...
#SBATCH --error=/rds/user/wd304/hpc-work/m3_inpaint_adj/tasks/%A_%a.err
#SBATCH --output=/rds/user/wd304/hpc-work/m3_inpaint_adj/tasks/%A_%a.out
...
task=$(sed -n "${TASK_ID}p" /rds/user/wd304/hpc-work/m3_inpaint_adj/tasks/tasks.txt)
