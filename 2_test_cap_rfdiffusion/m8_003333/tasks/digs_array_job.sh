...
#SBATCH --error=/rds/user/wd304/hpc-work/20241101_pipeline_RFdiffusion/tasks/%A_%a.err
#SBATCH --output=/rds/user/wd304/hpc-work/20241101_pipeline_RFdiffusion/tasks/%A_%a.out
...
task=$(sed -n "${TASK_ID}p" /rds/user/wd304/hpc-work/20241101_pipeline_RFdiffusion/tasks/tasks.txt)
