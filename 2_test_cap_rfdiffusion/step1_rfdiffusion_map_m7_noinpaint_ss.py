...
REMOTE_DIR = "/rds/user/wd304/hpc-work/m7_ss"
LOCAL_FILE_PATH = "/home/eva/0_bury_charged_pair/4_Test_cap/m7_ss"
INPUT_PDB_SOURCE = "/home/eva/0_bury_charged_pair/4_Test_cap/input/3ult_cleaned_renumbered_monomer_modified2.pdb"
...
crop_NT_list = range(1, 2)  # N-terminal cropping from 1 (no crop) to 1 (max crop). You crop everything before this residue.
crop_CT_list = range(114, 115)  # C-terminal cropping from 114 (max crop) to 115 (no crop). You crop everything after this residue.
