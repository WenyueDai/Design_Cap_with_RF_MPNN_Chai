...
#SBATCH --error=/rds/user/wd304/hpc-work/20250101_RFdiffusion_test/tasks/%A_%a.err
#SBATCH --output=/rds/user/wd304/hpc-work/20250101_RFdiffusion_test/tasks/%A_%a.out
#SBATCH --array=1-2  # Corrected array specification
...
task=$(sed -n "${TASK_ID}p" /rds/user/wd304/hpc-work/20250101_RFdiffusion_test/tasks/tasks.txt)
